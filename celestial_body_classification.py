...
def celestial_body(data_file, iterations=3000, learning_rate=0.1, reg_param=0.1, tuning=False, plot_learning_curves=False, plot_results=False):
...
def objective(hyper_params):
    ...
    # model.train_model(X_train_std.T, y_train.T, parameters, V, iterations, learning_rate, reg_param)
    model.train_mini_batch_model(X_batches, y_batches, parameters, V, iterations, learning_rate, reg_param)
